...
before_normalized_df=liver_patients_df[['Total_Bilirubin','Direct_Bilirubin', 'Alkaline_Phosphotase', 'Alamine_Aminotransferase']]
normalized_data=scaler.fit_transform(before_normalized_df)
